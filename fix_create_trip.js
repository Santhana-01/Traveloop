...
const js = `import React, { useEffect, useState, useMemo } from 'react';
...
const jsPath = path.join(__dirname, 'src', 'pages', 'CreateTrip.js');
fs.writeFileSync(jsPath, js);

const cssPath = path.join(__dirname, 'src', 'styles', 'CreateTrip.css');
let css = fs.readFileSync(cssPath, 'utf8');
if (!css.includes('.checkbox-group')) {
  css += `
...
console.log('CreateTrip.js and CreateTrip.css updated successfully');
