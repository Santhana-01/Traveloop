...
'@
Set-Content -Path 'c:\Users\hp\Downloads\traveloop odoo\src\pages\CreateTrip.js' -Value $content
...
Write-Host 'CreateTrip.js and CreateTrip.css updated successfully'
